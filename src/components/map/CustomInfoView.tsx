  ...
  return (
    <div className="w-full max-w-[350px] p-1 pt-0">
      ...
      <div className="flex flex-col mt-2 font-lato text-base">
        <span className="text-sm text-white bg-gray-400 font-bold p-1">Description</span>
        <p className="bg-gray-100 p-1">{selectedPoi.description}</p>
      </div>

      <div className="flex flex-col mt-2 font-lato text-base">
        <span className="text-sm text-white bg-gray-400 font-bold p-1">Opening hours</span>
        <p className="bg-gray-100 p-1">{selectedPoi.openingHours}</p>
      </div>

      <div className="flex flex-col mt-2 font-lato text-base">
        <span className="text-sm text-white bg-gray-400 font-bold p-1">Contact</span>
