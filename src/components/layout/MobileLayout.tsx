...
import MobileLayoutLink from './MobileLayoutLink.tsx'

const MobileLayout: FunctionComponent = () => {
  return (
    <div className="z-40 w-[95%] max-w-[360px] h-[75px] font-bold font-merryweather bg-white drop-shadow-md absolute bottom-3 left-1/2 -translate-x-1/2 rounded-sm flex items-center place-content-around gap-3">
