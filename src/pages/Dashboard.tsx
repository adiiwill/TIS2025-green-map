...
const Dashboard = () => {
  ...
  return (
    <Layout title="Dashboard">
      <div className="bg-[#f2f2f2] min-h-[calc(100vh-90px)] relative flex flex-col items-center pb-28 xl:pb-0">
        <div className="flex justify-between p-8 h-[800px] xl:h-[380px] xl:flex-row flex-col gap-6 w-full">
          <div className="p-12 pt-15 xl:bg-white bg-mainGreen drop-shadow-md font-merryweather rounded-sm flex justify-center">
            <h2 className="self-start absolute top-4 left-4 text-3xl font-bold text-white xl:text-mainGray">
              Pois
            </h2>
          ...
          <div className="p-2 xl:p-4 xl:pb-2 xl:pt-6 bg-white drop-shadow-md font-merryweather rounded-sm overflow-x-scroll w-full h-full">
            <BarGraph />
          </div>
        </div>

        <div className="flex justify-between p-8 pt-0 h-[800px] xl:h-[380px] xl:flex-row flex-col gap-6 w-full">
          <div className="p-4 pb-2 pt-6 bg-white drop-shadow-md font-merryweather rounded-sm overflow-x-scroll w-full h-full">
            <ScatterChart />
          </div>
          <div className="flex bg-white drop-shadow-md font-merryweather rounded-sm p-4 py-8 xl:py-0 xl:p-8">
            <Calendar />
          </div>
        </div>
      </div>
